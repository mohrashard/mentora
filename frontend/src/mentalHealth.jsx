...
const generatePersonalizedTips = (resultsData) => {
  ...
  if (resultsData.inputData?.Sleep_Hours < 6) {
    tips.push(
      "Aim for 7-9 hours of sleep each night for better mental health."
    );
  ...
  const socialLevel =
    resultsData.inputData?.Social_Interaction_Level?.toLowerCase();
  if (socialLevel === "low") {
    tips.push(
      "Make time for social connections, even brief interactions can help."
    );
...
const MentalHealthPredictionForm = () => {
  ...
  const fetchLastPrediction = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5002/user/${userId}/history`
      );
      if (response.ok) {
          ...
          const transformed = {
            ...
            insights: {
              caffeine_intake_level:
                latest.input_data.Caffeine_Intake_mg_per_day > 400
                  ? "High"
                  : latest.input_data.Caffeine_Intake_mg_per_day > 200
                  ? "Moderate"
                  : "Low",
              high_caffeine_detected:
                latest.input_data.Caffeine_Intake_mg_per_day > 400,
              risk_factors_identified: latest.recommendations.filter(
                (r) =>
                  r.includes("Consider") ||
                  r.includes("Try") ||
                  r.includes("reduce") ||
    ...
    switch (step) {
      ...
      case 3:
        ...
        if (!formData.social_interaction_level) {
          newErrors.social_interaction_level =
            "Please select your social interaction level";
        }
        break;
      case 4:
        if (
        ...
        if (
          ...
          newErrors.physical_activity =
            "Please enter valid physical activity hours (0-24)";
        }
        if (
          !formData.diet_quality ||
          formData.diet_quality < 1 ||
          formData.diet_quality > 10
        ) {
          newErrors.diet_quality = "Please enter diet quality (1-10)";
        }
        if (
          !formData.work_study_hours ||
          formData.work_study_hours < 0 ||
          formData.work_study_hours > 24
        ) {
          newErrors.work_study_hours =
            "Please enter valid work/study hours (0-24)";
        }
        if (!formData.employment_status) {
          newErrors.employment_status = "Please select your employment status";
        }
        if (!formData.chronic_health_issues) {
          newErrors.chronic_health_issues =
            "Please select chronic health issues status";
        }
        break;
      default:
        break;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5002/predictmentalhealth",
        {
          method: "POST",
          headers: {
          ...
          <div className="form-container">
            <div className="lock-notice">
              ...
              <h2 className="lock-title">
                Mental Health Prediction Assessment
              </h2>
              <div className="lock-message">
                You've already taken today's assessment.
                <br />
                You can take the next one tomorrow.
              </div>
            </div>

            <div className="results-container">
              <h2 className="step-title">
                Your Latest Mental Health Prediction Results
              </h2>
              ...
              <div className="prediction-summary">
                ...
                <div className="prediction-item">
                  ...
                  <span className="prediction-value">
                    {resultsData.predictions.mental_health_status}
                  </span>
                </div>
                <div className="prediction-item">
                  <span className="prediction-label">Depression Level:</span>
                  <span className="prediction-value">
                    {resultsData.predictions.depression_level}
                  </span>
                </div>
                <div className="prediction-item">
                  <span className="prediction-label">Anxiety Presence:</span>
                  <span className="prediction-value">
                    {resultsData.predictions.anxiety_presence}
                  </span>
                </div>
              </div>
                ...
                {resultsData.insights.high_caffeine_detected && (
                  <div className="insight-item">
                    <span className="warning-badge">
                      ⚠️ High caffeine consumption detected
                    </span>
                  </div>
                )}
                <div className="insight-item">
      ...
      <div className="main-content">
        <div className="form-container">
                ...
                {formData.drinks.length > 0 && (
                  <div className="caffeine-summary">
                    <div className="caffeine-total">
                      Total estimated caffeine: {calculateTotalCaffeine()}{" "}
                      mg/day
                    </div>
                  </div>
                )}
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("sleep_hours", e.target.value)
                    }
                    min="0"
                    max="24"
                    step="0.5"
                  ...
                  />
                  {errors.sleep_hours && (
                    <div className="error-message">{errors.sleep_hours}</div>
                  )}
                </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("mood_rating", e.target.value)
                    }
                    min="1"
                    max="10"
                    placeholder="5"
                  />
                  {errors.mood_rating && (
                    <div className="error-message">{errors.mood_rating}</div>
                  )}
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("stress_level", e.target.value)
                    }
                  >
                    <option
                  ...
                  {errors.stress_level && (
                    <div className="error-message">{errors.stress_level}</div>
                  )}
                </div>
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("smoking_habits", e.target.value)
                    }
                  >
                    <option
                      style={{ backgroundColor: "#1e293b", color: "#ffffff" }}
                  ...
                  {errors.smoking_habits && (
                    <div className="error-message">{errors.smoking_habits}</div>
                  )}
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("drinking_habits", e.target.value)
                    }
                  >
                    <option
                      style={{ backgroundColor: "#1e293b", color: "#ffffff" }}
                ...
                <div className="form-group">
                  ...
                  >
                    <option
                      ...
                      value=""
                    >
                      Select Social Interaction Level
                    </option>
                    <option
                      style={{ backgroundColor: "#1e293b", color: "#ffffff" }}
                      value="Low"
          ...
          {currentStep === 4 && (
            <div className="step-content">
              <h2 className="step-title">
                Step 4: Additional Lifestyle Details
              </h2>
              <div className="form-row">
                <div className="form-group">
                  ...
                  />
                  {errors.screen_time && (
                    <div className="error-message">{errors.screen_time}</div>
                  )}
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("physical_activity", e.target.value)
                    }
                    min="0"
                    max="24"
                    placeholder="e.g. 3"
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("diet_quality", e.target.value)
                    }
                    min="1"
                    max="10"
                    placeholder="e.g. 5"
                  />
                  {errors.diet_quality && (
                    <div className="error-message">{errors.diet_quality}</div>
                  )}
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("work_study_hours", e.target.value)
                    }
                    min="0"
                    max="24"
                    placeholder="e.g. 8"
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("chronic_health_issues", e.target.value)
                    }
                  >
                    <option
                      style={{ backgroundColor: "#1e293b", color: "#ffffff" }}
          ...
          {currentStep === 5 && !resultsData && (
            <div className="step-content">
              ...
              <div className="review-section">
                  ...
                  {formData.drinks.length === 0 ? (
                    <div className="review-item">
                      <span className="review-value">
                        No caffeinated drinks recorded
                      </span>
                    </div>
                  ) : (
                    <>
                      ...
                      <div className="review-item">
                        <span className="review-label">
                          <strong>Total Caffeine:</strong>
                        </span>
                        <span className="review-value">
                          <strong>{calculateTotalCaffeine()} mg/day</strong>
                        </span>
                      </div>
                    </>
                  )}
                ...
                <div className="review-category">
                  ...
                  <div className="review-item">
                    ...
                    <span className="review-value">
                      {formData.screen_time} hours/day
                    </span>
                  </div>
                  <div className="review-item">
                    <span className="review-label">Physical Activity:</span>
                    <span className="review-value">
                      {formData.physical_activity} hours/day
                    </span>
                  </div>
                  <div className="review-item">
                  ...
                  <div className="review-item">
                    ...
                    <span className="review-value">
                      {formData.work_study_hours} hours/day
                    </span>
                  </div>
                  <div className="review-item">
                  ...
                  <div className="review-item">
                    ...
                    <span className="review-value">
                      {formData.chronic_health_issues}
                    </span>
                  </div>
                </div>
              </div>
              ...
              {errors.submit && (
                <div className="error-message">Error: {errors.submit}</div>
              )}
          ...
          {resultsData && (
            <div className="step-content results-container">
              <h2 className="step-title">
                Your Mental Health Prediction Results
              </h2>
              ...
              <div className="confidence-scores">
                  ...
                  <div>
                    <div className="confidence-bar">
                      <div
                        ...
                        style={{
                          width: `${
                            resultsData.predictions.confidence_scores
                              .mental_health * 100
                          }%`,
                        }}
                      ></div>
                ...
                <div className="confidence-item">
                  ...
                  <div>
                    ...
                    <span>
                      {(
                        resultsData.predictions.confidence_scores.depression *
                        100
                      ).toFixed(1)}
                      %
                    </span>
                  ...
                  <div>
                    <div className="confidence-bar">
                      <div
                        ...
                        style={{
                          width: `${
                            resultsData.predictions.confidence_scores.anxiety *
                            100
                          }%`,
                        }}
                      ></div>
                    ...
                    <span>
                      {(
                        resultsData.predictions.confidence_scores.anxiety * 100
                      ).toFixed(1)}
                      %
                    </span>
                  </div>
